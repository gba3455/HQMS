...
//            	// ---------------- 诊断 ---------------------------
//            	// 创建诊断SQL
//            	diagnose_sql = "select FICDM 主要诊断编码,fsxzd 主要诊断疾病描述,FRYBQBH 主要诊断入院病情,FZLJGBH 主要诊断出院情况 from HIS_BA3 where FPRN = '" + patient.getP3() + "' order by FZDLX,FID asc";
...
//            	// ---------------- 手术 ---------------------------
//            	// 创建手术SQL
//            	operation_sql = "select distinct(FOPCODE), \r\n" + 
